...
async def on_message(message: Message):
    ...
    if text in ("/start", "start", "شروع"):
        ...
        await message.reply(
            "👞 ربات بهای تمام‌شده «تعاونی کفاشان دست‌دوز تهران»\n"
            "─────────────────\n"
            "به ربات محاسبه‌ی بهای تمام‌شده‌ی کفش دست‌دوز خوش آمدید.\n\n"
            "این ربات کمک می‌کند هزینه‌ی واقعی تولید هر جفت کفش را دقیق محاسبه کنید "
            "و قیمت فروش منطقی به‌دست آورید.\n\n"
            "کافیست هزینه‌ی هر آیتم را برای یک جفت کفش وارد کنید تا در پایان، "
            "بهای تمام‌شده و قیمت فروش را تحویل بگیرید.\n"
            "─────────────────\n"
